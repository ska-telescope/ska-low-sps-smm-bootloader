/*
 * Copyright (C) 2015 Sanitas EG
 *
 * Author: Davide Rizzi <davide.rizzi@sanitaseg.com>
 *
 * Configuration settings for the Sanitas Inventami board.
 *
 * SPDX-License-Identifier:	GPL-2.0+
 */

#ifndef __INVENTAMI_CONFIG_H
#define __INVENTAMI_CONFIG_H
			...
			"for disk in 1 0 ; do ${dtype} dev ${disk} ;" \
				"for fs in fat ext2 ; do " \
					"${fs}load " \
						"${dtype} ${disk}:1 " \
						"10008000 " \
						"/inventami.bootscript " \
						"&& source 10008000 ; " \
				"done ; " \
			"done ; " \
		"done; " \
		"echo ; echo inventami.bootscript not found ; " \
